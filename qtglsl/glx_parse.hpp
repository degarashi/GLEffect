...
struct GLShadertype_ : qi::symbols<char, unsigned> {
	GLShadertype_(): symbols(std::string("ShaderType")) {
		add("vertexshader", (unsigned)ShType::VERTEX)
			("pixelshader", (unsigned)ShType::PIXEL)
			("geometryshader", (unsigned)ShType::GEOMETRY);
	}
};
...
FUSION_ADAPT_STRUCT_AUTO(AttrEntry, (prec)(type)(name)(sem))
FUSION_ADAPT_STRUCT_AUTO(VaryEntry, (prec)(type)(name))
FUSION_ADAPT_STRUCT_AUTO(UnifEntry, (prec)(type)(name)(sizeSem)(defStr))
FUSION_ADAPT_STRUCT_AUTO(ConstEntry, (prec)(type)(name)(defVal))
FUSION_ADAPT_STRUCT_AUTO(BoolSetting, (type)(value))
FUSION_ADAPT_STRUCT_AUTO(ValueSetting, (type)(value))
FUSION_ADAPT_STRUCT_AUTO(ShSetting, (type)(shName)(args))
FUSION_ADAPT_STRUCT_AUTO(MacroEntry, (fromStr)(toStr))
FUSION_ADAPT_STRUCT_AUTO(AttrStruct, (name)(derive)(entry))
FUSION_ADAPT_STRUCT_AUTO(VaryStruct, (name)(derive)(entry))
